...
const steps = ['discovery', 'brief', 'booking', 'preshoot', 'delivery'] as const;

export default async function HowItWorksBrands() {
  const t = await getTranslations('Brands.howItWorks');
